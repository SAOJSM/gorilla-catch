(function () {
    ...
    cat.innerHTML = `<div id="catCatchRecorderinnerCropArea"></div>
        <div id="catCatchRecorderHeader">
            ...
            <div id="catCatchRecorderStart" data-i18n="startRecording">開始錄製</div>
            <div id="catCatchRecorderTitle" data-i18n="dragWindow">拖動視窗</div>
            <div id="catCatchRecorderClose" data-i18n="close">關閉</div>
        </div>`;
    ...
    async function startRecording() {
        ...
        recorder.onstart = function (e) {
            buffer.slice(0);
            catCatchRecorderStart.innerHTML = i18n("stopRecording", "停止錄製");
        ...
        recorder.onstop = function () {
            ...
            recorder = undefined;
            catCatchRecorderStart.innerHTML = i18n("startRecording", "開始錄製");
